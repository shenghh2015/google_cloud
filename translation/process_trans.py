...
def main():
    ...
    if args.end_id > args.start_id:
        output_name = output_name.replace('.pydict', f'_s{args.start_id}_e{args.end_id}.pydict')
    ...
    # dataset
    known_ids = [int(i) for i in args.known_ids.split(',')] if args.known_ids else []
    dataset = Dataset(args.input_path, args.start_id, args.end_id, args.id_ref_path, known_ids)
